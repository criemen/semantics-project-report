...
\newcommand{\coloredset}[1]{{\color{violet}$\{#1\}$}}
...
\newcommand{\clclean}{:\ {\color{violet}$\lclean$}}
\newcommand{\cltracked}{:\ {\color{violet}$\ltracked$}}
\newcommand{\clunknown}{:\ {\color{violet}$\lunknown$}}
