...
\begin{figure}[h]
    \begin{tikzpicture}[roundnode/.style={rectangle,rounded corners=1ex,draw=black!100,thick},->,thick]
        ...
        \node[roundnode] (storemult) at (6, -3) {$\storecmd{Z1}{Z4 * X}$};
        ...
        \draw (source.south) -- (storez0.north);
        \draw (storez0.south) -- (phiz4.north);
        \draw (phiz4.north east) -- (mult.north);
        \draw (storemult.west) -- (phiz3.east);
        \draw (phiz4.south) -- (varaccessz4.north);
        \draw (varaccessz4.south) -- (storez2.north);
        \draw (storez2.south) -- (phiz3.north);
        \draw[->,thick] (phiz3.west) to [out=180,in=180] (phiz4.west);
