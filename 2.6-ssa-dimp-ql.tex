...
The algorithm uses the following propagation rules:
...
To see how the candidate label computation work, recall the dataflow graph
from~\autoref{fig:df-graph}.
We have included the annotated dataflow graph here at several stages of the algorithm:
\begin{enumerate}
    \item After the static initialization phase, but before the recursive label propagation starts: ~\autoref{fig:label-graph-1}
    \item In the middle of the recursive label propagation: ~\autoref{fig:label-graph-2}
    \item After the algorithm has finished computing candidate node labels: ~\autoref{fig:label-graph-3}
\end{enumerate}
...
\begin{figure}[h]
    \begin{tikzpicture}[roundnode/.style={rectangle,rounded corners=1ex,draw=black!100,thick},->,thick]
        ...
        \node[roundnode] (phii2) at (0, 5) {$\phistore{I2}{I0}{I1}$  $\{\lunknown\}$};
...
\begin{figure}[h]
    \begin{tikzpicture}[roundnode/.style={rectangle,rounded corners=1ex,draw=black!100,thick},->,thick]
        ...
        \node[roundnode] (phii2) at (0, 5) {$\phistore{I2}{I0}{I1}$  $\{\lunknown\}$};
        \node[roundnode] (readi21) at (-4, 4) {VarAccess $I2$ $\{\lunknown\}$};
        \node[roundnode] (readi22) at (4, 4) {VarAccess $I2$ $\{\lunknown\}$};
        \node[roundnode] (writei1) at (7, 3) {$\storecmd{I1}{I2 - I1}$  $\{\lclean\}$};
        \draw (ivarx.south) -- (i0getsx.north);
        \draw (i0getsx.south) -- (phii2.north);
        \draw (phii2.south) -- (readi21.north);
    ...
    \caption{The annotated dataflow graph during the label propagation}
...
\begin{figure}[h]
    \begin{tikzpicture}[roundnode/.style={rectangle,rounded corners=1ex,draw=black!100,thick},->,thick]
        ...
        \node[roundnode] (ivarx) at (0, 7) {VarAccess $X$ $\{\lclean\}$};
        \node[roundnode] (i0getsx) at (0, 6) {$\storecmd{I0}{X}$ $\{\lclean\}$};
        \node[roundnode] (phii2) at (0, 5) {$\phistore{I2}{I0}{I1}$  $\{\lunknown, \lclean\}$};
        \node[roundnode] (readi21) at (-4, 4) {VarAccess $I2$ $\{\lunknown, \lclean\}$};
        \node[roundnode] (readi22) at (4, 4) {VarAccess $I2$ $\{\lunknown, \lclean\}$};
        \node[roundnode] (writei1) at (7, 3) {$\storecmd{I1}{I2 - I1}$  $\{\lclean\}$};
        \draw (ivarx.south) -- (i0getsx.north);
        \draw (i0getsx.south) -- (phii2.north);
        \draw (phii2.south) -- (readi21.north);
    ...
    \caption{The annotated dataflow graph after the label propagation}
