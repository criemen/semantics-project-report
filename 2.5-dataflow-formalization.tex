...
\newcommand{\bigsteppl}[4]{\langle #1, #2, #3 \rangle \downarrow^{\Phi_1} #4}
\newcommand{\bigsteppr}[4]{\langle #1, #2, #3 \rangle \downarrow^{\Phi_2} #4}
...
\begin{align*}
    ...
    \mid \defaultssaif\\
    &\mid \defaultssawhile \\
    \Phi_{list} \Coloneqq &\:[] \mid \Phi_{node} : \philist\\
...
\begin{align*}
    ...
    &\bsrule{E$\Phi_1$-Assgn}
    {\bigsteppl{\defaultphilist}{\store}{\store'}{\store''}}
    {\bigsteppl{\phistore{X_1}{Y_1}{Z_1} : \defaultphilist}{\store}{\store'}{\store'' \dunion [X_1 \mapsto \store'(Y_1)]}}\\
    &\bsrule{E$\Phi_2$-Empty}{}{\bigsteppr{[]}{\store}{\store'}{\store}}\\
    &\bsrule{E$\Phi_2$-Assgn}
    {\bigsteppr{\defaultphilist}{\store}{\store'}{\store''}}
    {\bigsteppr{\phistore{X_1}{Y_1}{Z_1} : \defaultphilist}{\store}{\store'}{\store'' \dunion [X_1 \mapsto \store'(Z_1)]}}\\
\end{align*}
...
\begin{definition}[Dataflow Graph]
    ...
    TODO ssa phi nodes are missing
\end{definition}
...
TODO phi nodes should get better treatment
...
\begin{definition}[Store-Read Chain]
    ...
    \begin{equation*}
        ...
        {\bigstep{\storecmd{X_i}{a_i}}{\store_i}{\store_i \dunion [X_i \mapsto \flagged{}]}},
        \E^2_i=\bsrule{EA-Loc}{}
    ...
    \end{enumerate}
    Because the program is in SSA form, store-read chains TODO are they cycle-free?
\end{definition}
\begin{lemma}
    Given a tuple $(c, \initialstore{})$ that has dataflow, every node
    of a variable read of $X$ with a
    derivation $\bsrule{EA-Loc}{}{\bigstep{X}{\sigma}{\flagged{}}}$
    has an incoming edge in the graph computed by $\B$.
\end{lemma}
\begin{proof}
    TODO
\end{proof}
