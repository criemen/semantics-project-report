...
\begin{definition}[Store-Read Chain]
    ...
    \end{align*}
    If $i \in \{1, \ldots, m-1\}$, it has to hold that 
        ...
        store in the chain. TODO think about explicit reads for phi nodes.
        TODO adjust\\
    \textbf{Case 2:}\\
    \begin{align*}
    ...
    %    {\bigsteppr{\defaultphilist}{\store}{\store''}{\store'}}
    %    {\bigsteppr{\phistore{X_i}{Y_i}{Z_i} : \defaultphilist}{\store}{\store''}{\storeassign{\store'}{X_1 \mapsto \store''(Z_1)}}}\\
    %\end{align*}
