...
\begin{theorem}[Progress-Ish]
    ...
    TODO add about booleans!
    Add two lemmas that do the work for boolean+arithmetic.
\end{theorem}
\begin{proof}
    Proof by induction over the derivation of $\E$.\\
    \textbf{Case 1:}
    Skip\\
    \textbf{Case 2:}
    Sink\\
    ...
    \textbf{Case 4:}
    \begin{align*}
        &\E = \bsrule{EC-IfT}{\bigstep{b}{\store}{\btrue}\qquad 
        \overset{\E_0}{\bigstep{s_0}{\store}{\store''}}
        \qquad \bigsteppl{\philist}{\dom\store}{\store''}{\store'}}
        {\bigstep{\defaultssaif}{\store}{\store'}}\\
        &\D = \rule{DF-If}{\typestmt{\Gamma}{b}\qquad
        \overset{\D_0}{\typestep{\Gamma}{s_0}{\Delta_0}}\qquad \typestep{\Gamma}{s_1}{\Delta_1}\qquad
        \typestep{\Gamma;\Delta_0;\Delta_1}{\philist}{\Delta}}
        {\typestep{\Gamma}{\defaultssaif}{\Delta}}
    \end{align*}
    Then we apply the IH on $\E_0$ with $\D_0$.
    \textbf{Case 5:}
    ...
    \end{align*}
    Then, because $\Gamma$ matches $\store$ by assumption we get that it still matches $\store$
    in all subexpressions $a_0$ of $a$ in $\typestep{\Gamma}{a_0}{L}$.
    {\color{red} Andrzej: This is a bit hand-wavy bit the entire induction over arithmetic expressions would
    be really boring to see. Do you think this is okay?}\\
    \textbf{Case 7:}\\
    \begin{align*}
        ...
        {\typestep{\Gamma}{\defaultssawhile}{\Delta}}
    \end{align*}
    TODO we need a lemma here about the while judgement.
\end{proof}
