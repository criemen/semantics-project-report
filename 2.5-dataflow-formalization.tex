...
\newcommand{\bigsteppl}[3]{\langle #1, #2 \rangle \downarrow^{\Phi1} #3}
\newcommand{\bigsteppr}[3]{\langle #1, #2 \rangle \downarrow^{\Phi2} #3}
...
\newcommand{\union}{\cup}
\newcommand{\storeassign}[2]{{#1} \union [{#2}]}
...
\\
Judgment \fbox{$\bigsteppl{\defaultphilist}{\sigma}{\sigma'}$}:
\begin{align*}
    &\bsrule{E$\Phi_1$-Assign}{}
    {\bigsteppl{\defaultphilistn}{\store}{\storeassign{\store}{X_1 \mapsto \store(Y_1),\ldots X_n \mapsto \store(Y_n)}}}\\
\end{align*}
Judgment \fbox{$\bigsteppr{\defaultphilist}{\sigma}{\sigma'}$}:
\begin{align*}
    &\bsrule{E$\Phi_2$-Assign}{}
    {\bigsteppr{\defaultphilistn}{\store}{\storeassign{\store}{X_1 \mapsto \store(Z_1),\ldots X_n \mapsto \store(Z_n)}}}\\
\end{align*}

\begin{landscape}
For while loops, we introduce a special judgment of the form \fbox{$\bigstepw{c}{\sigma}{\excstore'{}}$}:
\begin{align*}
    &\bsrule{EW-WhileF}{\bigsteppr{\defaultphilist}{\store}{\store'} \qquad
        \bigstep{b}{\store'}{\bfalse}}
    {\bigstepw{\defaultssawhile}{\store}{\store'}}\\
    &\bsrule{EW-WhileTAbrt}{\bigsteppr{\defaultphilist}{\store}{\store'} \qquad
        \bigstep{b}{\store'}{\btrue} \qquad 
    \bigstep{s_0}{\store'}{\exception}}
    {\bigstepw{\defaultssawhile}{\store}{\exception}}\\
    &\bsrule{EW-WhileT}{\bigsteppr{\defaultphilist}{\store}{\store''} \ 
        \bigstep{b}{\store''}{\btrue} \  
    \bigstep{s_0}{\store''}{\store'} \  
    \bigstepw{\defaultssawhile}{\store}{\excstore'}}
    {\bigstepw{\defaultssawhile}{\store}{\excstore'}}\\
 \end{align*}
\\
...
\begin{align*}
    &\bsrule{EC-WhileF}{\bigsteppl{\defaultphilist}{\store}{\store'} \qquad
        \bigstep{b}{\sigma'}{\bfalse}}
    {\bigstep{\defaultssawhile}{\store}{\store'}}\\
    &\bsrule{EC-WhileTAbrt}{\bigsteppl{\defaultphilist}{\store}{\store'} \qquad
    \bigstep{b}{\store'}{\btrue} \qquad 
    \bigstep{s_0}{\store'}{\exception}}
    {\bigstep{\defaultssawhile}{\sigma}{\exception}}\\
    &\bsrule{EC-WhileT0}{\bigsteppl{\defaultphilist}{\store}{\store''} \ 
        \bigstep{b}{\store''}{\btrue} \ 
    \bigstep{s_0}{\store''}{\store'''} \ 
